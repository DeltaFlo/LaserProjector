...
void setup()
{
    ...
    Serial.print((0b0111 >> 12));
    Serial.print((0b1111 >> 12));
    Serial.print((0b0111 << 12));
    Serial.print((0b1111 << 12));
    Serial.print(validateXY(574,33584));
    Serial.print(validateXY(33584, 574));
    Serial.print(validateXY(33257, 740));
    Serial.print(validateXY(33176, 771));
}
...
boolean validateXY(unsigned short x, unsigned short y)
{
    ...
    return ((x & 0x7000) == 0) && (y & (0b1111 >> 12) == 0);
}